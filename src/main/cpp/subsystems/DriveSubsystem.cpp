...
DriveSubsystem::DriveSubsystem()
  //Defining each Swereve Module
    : m_frontLeft{DriveConstants::kFrontLeftDriveMotorID,
                  DriveConstants::kFrontLeftTurningMotorID,
                  DriveConstants::kFrontLeftTurningEncoderID, true , false, true},

      m_rearLeft{
          DriveConstants::kRearLeftDriveMotorID,       DriveConstants::kRearLeftTurningMotorID,
          DriveConstants::kRearLeftTurningEncoderID, true , true, true},

      m_frontRight{
          DriveConstants::kFrontRightDriveMotorID,       DriveConstants::kFrontRightTurningMotorID,
          DriveConstants::kFrontRightTurningEncoderID, true, true, true},

      m_rearRight{
          DriveConstants::kRearRightDriveMotorID,       DriveConstants::kRearRightTurningMotorID,
          DriveConstants::kRearRightTurningEncoderID, true, false, true},
...
frc::Rotation2d DriveSubsystem::getRotation2D(){
  double yaw = m_gyro.GetYaw().GetValue().value() * (M_PI / 180);
  double pitch = m_gyro.GetPitch().GetValue().value() * (M_PI / 180);
  int xOffset = 0;
  int yOffset = 270;
